...
%type <no>  Program Slist Stmt InputStmt OutputStmt AsgStmt E Ifstmt Whilestmt
%token BEG END READ WRITE ID NUM PLUS MINUS MUL DIV EQUAL IF Then Else ENDIF WHILE DO ENDWHILE
%left COMP
%left PLUS MINUS
%left MUL DIV
%right EQUAL
