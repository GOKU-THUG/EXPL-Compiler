...
static const yytype_int16 yyrline[] =
{
     ...
     104,   107,   109,   110,   112,   113,   116,   119,   120,   123,
     124,   127,   139,   140,   143,   154,   168,   169,   172,   186,
     187,   189,   190,   191,   193,   194,   195,   196,   197,   198,
     199,   200,   201,   202,   203,   204,   205,   206,   208,   209,
     211,   212,   214,   215,   216,   217,   218,   219,   220,   221,
     222,   224,   226,   229,   234,   235,   236,   237,   239,   241,
     245,   251,   254,   258,   261,   263,   265,   269,   275,   276,
...
#line 116 "parse.y"
                                                                                    {printf("Classtable:\n");printclasstable(Cptr);Cptr=NULL;}
#line 1687 "y.tab.c"
    break;
...
#line 294 "parse.y"
                                                {struct tnode* var=makeVariableNode((yyvsp[-5].c));
												 struct tnode* newnode=dynamicmemorynode(var->type,New,NULL,NULL);
...
#line 297 "parse.y"
                                                {
                                                    struct tnode* newnode=dynamicmemorynode((yyvsp[-5].no)->type,New,NULL,NULL);
													(yyval.no)=makeOperatorNode('=',(yyvsp[-5].no),newnode);
                                                }
#line 2122 "y.tab.c"
    break;
...
#line 321 "parse.y"
                                                        ...
                                                        //First ID cannot be a class becausse the second id cannot be a data member
                                                        //printf("%s,%s",$<c>1,$<c>3);
                                                        struct tnode* var=makeVariableNode((yyvsp[-2].c));	
                                                        struct tnode* field;
...
#line 373 "parse.y"
                                                            ...
                                                            //This will not occur inside a class.Eg:a.b(c):WIthin functions outside class
                                                            struct tnode* temp=(yyvsp[-1].no);
                                                            struct tnode* var=makeVariableNode((yyvsp[-5].c));
